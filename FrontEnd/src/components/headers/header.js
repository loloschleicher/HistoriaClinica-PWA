...
class Header extends React.Component {
  constructor(props) {
    ...
    this.menuUsuario = this.menuUsuario.bind(this);
  } //END constructor()------------------------------------------------------------------------------------------------------------
      ...
      return (
        <nav className="navbar navbar-dark navbar-2 bg-info mb-4">
          ...
          <button
            ...
            data-target="#navbarSupportedContent14"
          ...
          >
            <ul className="navbar-nav mr-auto">
              ...
              <li className="nav-item">
                <p style={{ color: "black" }} onClick={this.menuUsuario}>
                  Menu de Usuario
                </p>
              </li>
              ...
              <li className="nav-item">
                <Link from="/" to="/SingIn">
                  <p style={{ color: "black" }}>Registrar Nueva Cuenta</p>
                </Link>
              </li>

              <li className="nav-item">
                <Link to="/home">
                  <p style={{ color: "black" }} onClick={this.logout}>
                    Salir
                  </p>
                </Link>
              </li>
              <li>
                <Link to="/DetallesAtencionMedica">
                  <p style={{ color: "black" }}>
                    PruebaDetalleAtencionMedNoBorrar
                  </p>
                </Link>
              </li>
            </ul>
